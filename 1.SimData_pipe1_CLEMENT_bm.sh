...
if ! options=$(getopt -o h --long SCRIPT_DIR:,INPUT_TSV:,NPVAF_DIR:,SIMPLE_KMEANS_DIR:,CLEMENT_DIR:,SCICLONE_DIR:,PYCLONEVI_DIR:,QUANTUMCLONE_DIR:,COMBINED_OUTPUT_DIR:,NUM_CLONE_TRIAL_START:,NUM_CLONE_TRIAL_END:,FP_RATIO:,MAXIMUM_NUM_PARENT:,DEPTH_CUTOFF:,VERBOSE:,TRIAL_NO:,RANDOM_SEED:,SCORING:,MODE: -- "$@")
then
