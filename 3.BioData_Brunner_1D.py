...
# python3 /data/project/Alzheimer/YSscript/cle/3.BioData_Brunner_1D.py
...
if __name__ == "__main__":
    INPUT_TSV_DIR = "/data/project/Alzheimer/CLEMENT/01.INPUT_TSV/3.BioData/Brunner_1D"
    ...
    INPUT_DIR_LIST = natsorted (  glob.glob(INPUT_TSV_DIR + "/PD37115b*") ) 
    ...
    for INPUT_TSV in INPUT_DIR_LIST:
        kwargs = {"INPUT_TSV" : INPUT_TSV,  "MODE" : "Both",  "NUM_CLONE_TRIAL_START" : 1, "NUM_CLONE_TRIAL_END" : 5, 
                        "TRIAL_NO" : 5, "DEPTH_CUTOFF" : 10,  "KMEANS_CLUSTERNO" : 6, "MIN_CLUSTER_SIZE" : 20,  "MAKEONE_STRICT" :  3,
        ...
        kwargs["NPVAF_DIR"] = "/data/project/Alzheimer/CLEMENT/02.npvaf/3.BioData/Brunner_1D/" + SAMPLENAME
        kwargs["COMBINED_OUTPUT_DIR"] = "/data/project/Alzheimer/CLEMENT/03.combinedoutput/3.BioData/Brunner_1D/" + SAMPLENAME
        kwargs["SIMPLE_KMEANS_DIR"] = "/data/project/Alzheimer/YSscript/cle/data/SIMPLE_KMEANS/3.BioData/Brunner_1D/" + SAMPLENAME
        kwargs["CLEMENT_DIR"] = "/data/project/Alzheimer/YSscript/cle/data/CLEMENT/3.BioData/Brunner_1D/"  + SAMPLENAME
        kwargs["PYCLONEVI_DIR"] = "/data/project/Alzheimer/YSscript/cle/data/pyclone-vi/3.BioData/Brunner_1D/" + SAMPLENAME
        kwargs["SCICLONE_DIR"] = "/data/project/Alzheimer/YSscript/cle/data/sciclone/3.BioData/Brunner_1D/" + SAMPLENAME
        kwargs["QUANTUMCLONE_DIR"] = "/data/project/Alzheimer/YSscript/cle/data/quantumclone/3.BioData/Brunner_1D/" + SAMPLENAME
        ...
        logPath = "/data/project/Alzheimer/YSscript/cle/log/3.BioData/Brunner_1D/" + SAMPLENAME
        os.system ("rm -rf " + logPath)
        os.system ("mkdir -p " + logPath)
        
        command = " ".join ( [ "qsub -pe smp 1", "-e", logPath, "-o", logPath, 
                                                "-N Brunner_1D_" + SAMPLENAME, 
