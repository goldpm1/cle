...
parser.add_argument('--in_file', default="/data/project/Alzheimer/EM_cluster/pilot/04.EM_input/pyclone_vi/pyclone_vi_220610.h5")
parser.add_argument('--out_file', default="/data/project/Alzheimer/EM_cluster/pilot/04.EM_input/pyclone_vi/pyclone_vi_output_220610.tsv")
